    ...
    <div class="main_container">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <center>
              &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span>
                  <font size="4.95" color="white" face="Helvetica Neue">APLIKASI BUKU</font>
                </span></a>
            </center>
          </div>
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="#"><i class="fa fa-desktop"></i> Data Buku <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="index.php?page=tambah_buku">Tambah Data</a></li>
                  </ul>
                </li>
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open">
                <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/images/image.jpg" alt="">Siti Nabilah Nida
                </a>
      ...
      <footer>
        <div class="pull-right">
          Copyright @ 2021 Data Buku : Siti Nabilah Nida
        </div>
        <div class="clearfix"></div>
      </footer>
      <!-- /footer content -->
